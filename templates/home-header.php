    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = ariclaw_opt( 'ariclaw_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo ariclaw_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( ariclaw_featured_post_cat() ){
                                echo '<span class="entry__category">'.ariclaw_featured_post_cat().'</span>';
                            }
                            ?>
