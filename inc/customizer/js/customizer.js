(function( $ , api){
    ...
    api.section( 'ariclaw_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'ariclaw_about_section' , function( section ){
    ...
    api.section( 'ariclaw_blog_section' , function( section ){
    ...
    api.section( 'ariclaw_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-ariclaw_contact_custom_formshortcode'),
                selector = $('#_customize-input-ariclaw_contact_formshortcode');
    ...
    // General section
    api.section( 'ariclaw_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#ariclaw_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-ariclaw_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-ariclaw_preloader_color' );
            ...
            var $backtotop          = $( '#ariclaw_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-ariclaw_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-ariclaw_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'ariclaw_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#ariclaw_footer_widget_toggle');
