	...
	final class Ariclaw{
		...
		private function enqueue(){
			...
			$scripts = array(
				'style' => array(
					array(
						'handler'		=> 'ariclaw-theme-google-font',
						'file' 			=> $this->google_font(),
					),
					array(
						'handler'		=> 'ariclaw-theme-bootstrap',
						'file' 			=> $cssPath.'bootstrap.min.css',
						'dependency' 	=> array(),
						'version' 		=> '5.3.8-5',
					),
					array(
						'handler'		=> 'ariclaw-theme-animate',
						'file' 			=> $cssPath.'animate.css',
						'dependency' 	=> array(),
						'version' 		=> '1.0',
					),
					array(
						'handler'		=> 'ariclaw-theme-owl-carousel',
						'file' 			=> $cssPath.'owl.carousel.min.css',
						'dependency' 	=> array(),
						'version' 		=> '1.0',
					),
					array(
						'handler'		=> 'ariclaw-theme-font-awesome',
						'file' 			=> $cssPath.'font-awesome.min.css',
						'dependency' 	=> array(),
						'version' 		=> '7.3.1-1',
					),
					array(
						'handler'		=> 'ariclaw-theme-themify',
					...
					array(
						'handler'		=> 'ariclaw-theme-slick-css',
					...
					array(
						'handler'		=> 'ariclaw-theme-default-css',
					...
					array(
						'handler'		=> 'ariclaw-theme-ariclaw-style',
				...
				'scripts' => array(
					...
					array(
						'handler'		=> 'ariclaw-theme-magnific-popup-js',
					...
					array(
						'handler'		=> 'ariclaw-theme-swiper-min-js',
					...
					array(
						'handler'		=> 'ariclaw-theme-slick-min-js',
					...
					array(
						'handler'		=> 'ariclaw-theme-gijgo-min-js',
