...
/**
 *
 * ariclaw elementor about page section widget.
 *
 * @since 1.0
 */
class Ariclaw_Contact extends Widget_Base {

    public function get_name() {
        return 'ariclaw-contact';
    }

    public function get_title() {
        return __( 'Contact', 'ariclaw' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Contact Info', 'ariclaw' ),
            ]
        );

        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'ariclaw' ),
                ...
                'fields'  => [
                    [
                        ...
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'ariclaw' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'ariclaw' ),
                        'type'    => Controls_Manager::TEXTAREA,
                        'default' => esc_html__( 'Write something...', 'ariclaw' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'ariclaw' ),
                        'type'  => Controls_Manager::ICON,
                        'options' => ariclaw_themify_icon()
                    ]
        ...
        $this->start_controls_section(
            'contact_form',
            [
                'label' => __( 'Contact Form', 'ariclaw' ),
            ]
        );
        $this->add_control(
            'contact_form_title',
            [
                'label'     => esc_html__( 'Contact Form Title', 'ariclaw' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Get in Touch', 'ariclaw')
            ]
        );
        $this->add_control(
            'contact_formshortcode',
            [
                'label'     => esc_html__( 'Form Shortcode', 'ariclaw' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true
            ]
        );
        ...
        $this->start_controls_section(
            'style_content_color', [
                'label' => __( 'Style Content Color', 'ariclaw' ),
        ...
        $this->add_control(
            'color_title', [
                'label'     => __( 'Right Text Title Color', 'ariclaw' ),
        ...
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Right Text Sub Title Color', 'ariclaw' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#8a8a8a',
                'selectors' => [
