    ...
    final class Ariclaw_El_Widgets {
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            wp_register_script( 'ariclaw-map-custom', ARICLAW_DIR_ELEMENTOR . 'assets/js/map-custom.js', array(), '1.0-s2', true );

            // ariclaw companion main js
            wp_enqueue_script( 'ariclaw', ARICLAW_DIR_ELEMENTOR . 'assets/js/ariclaw-companion-main.js', array( 'ariclaw-ui-js' ), '1.0-s2', true );
        ...
        private function include_widgets() {
            ...
            require_once ARICLAW_DIR_PATH_ELEMENTOR_WIDGETS . '/widgets/practice-areas.php';
            require_once ARICLAW_DIR_PATH_ELEMENTOR_WIDGETS . '/widgets/case-study.php';
            require_once ARICLAW_DIR_PATH_ELEMENTOR_WIDGETS . '/widgets/reservation.php';
        ...
        private function register_widgets() {
            ...
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Ariclawelementor\Widgets\Ariclaw_Practice_Areas() );
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Ariclawelementor\Widgets\Ariclaw_Case_Study() );
            \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Ariclawelementor\Widgets\Ariclaw_Reservation() );
