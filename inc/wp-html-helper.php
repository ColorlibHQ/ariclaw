...
// image default alt
if( !function_exists( 'ariclaw_img_default_alt' ) ){
	function ariclaw_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'ariclaw_img_tag' ) ){
	function ariclaw_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = ariclaw_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'ariclaw_anchor_tag' ) ){
	function ariclaw_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'ariclaw_heading_tag' ) ){
	function ariclaw_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'ariclaw_paragraph_tag' ) ){
	function ariclaw_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'ariclaw_other_tag' ) ){
	function ariclaw_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'ariclaw_button_element ' ) ){
	function ariclaw_button_element( array $args ){
