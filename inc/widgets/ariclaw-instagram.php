...
----------------------------------------*/
class ariclaw_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('ariclaw_instagram_photo',esc_html__('[ Ariclaw ] Intagram Photo','ariclaw'),array(
			'description' => esc_html__('Ariclaw Instagram Photo Widget','ariclaw'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'ariclaw');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'ariclaw'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'ariclaw'); ?></label>
...
if(!function_exists('ariclaw_instagram_widgets')):
	function ariclaw_instagram_widgets(){
		register_widget('ariclaw_instagram_photo');
	}
	add_action('widgets_init','ariclaw_instagram_widgets');
endif;
