...
class Ariclaw_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'ariclaw_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Ariclaw ] Social Links', 'ariclaw' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'ariclaw' ), )
        );
    ...
    echo wp_kses_post( $args['before_title'] . $title . $args['after_title'] );
        ...
        <div class="social_icon">
            ...
            if( $twitter ){
                echo '<a href="'. esc_url( $twitter ) .'"><i class="ti-twitter-alt"></i></a>';
            }
            if( $dribbble ){
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'ariclaw' );
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:' ,'ariclaw'); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>"><?php esc_html_e( 'Short Description:' ,'ariclaw'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'ariclaw'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'ariclaw'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'ariclaw'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'ariclaw'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'ariclaw'); ?></label>
...
} // Class ariclaw_social_links ends here


// Register and load the widget
function ariclaw_social_links_widget_load() {
	register_widget( 'Ariclaw_social_links' );
}
add_action( 'widgets_init', 'ariclaw_social_links_widget_load' );